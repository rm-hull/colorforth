...
FORTH "screen",  "[COMPILESHORT]", "0",  "dup",  "at",  "[COMPILESHORT]", "1024",  "[COMPILESHORT]", "768",  "box",  ";"
...
FORTH "logo",  "show",  "black",  "screen",  "[COMPILESHORT]", "800",  "[COMPILESHORT]", "710",  "blue",  "box",  "[COMPILESHORT]", "600",  "[COMPILESHORT]", "50",  "at",  "[COMPILESHORT]", "1024",  "[COMPILESHORT]", "620",  "red",  "box",  "[COMPILESHORT]", "200",  "[COMPILESHORT]", "100",  "at",  "[COMPILESHORT]", "700",  "[COMPILESHORT]", "500",  "green",  "box",  "text",  "cf",  "keyboard",  ";"
