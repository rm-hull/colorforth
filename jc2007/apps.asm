...
FORTH xnext, [EXECUTE], xnow, @, dup, ;# get current x value
 FORTH [COMPILESHORT], 1, +, hp, mod, [EXECUTE], xnow, "!", ";" ;# increment
FORTH ynext, [EXECUTE], ynow, @, dup, ;# get current y value
 FORTH [COMPILESHORT], 1, +, vp, mod, [EXECUTE], ynow, "!", ";" ;# increment
...
FORTH iter, ;# iterate through the array of complex numbers, updating
 ...
 FORTH [COMPILEWORD], xnext, ynext, hp, *, over, over, +, ;# locate pixel
